 ...
 */
public class AntPathMatcherArraysTest {

    @Test
    public void isMatchWithCaseSensitiveWithDefaultPathSeparator() throws Exception {

        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder().build();
    ...
    public void isMatchWithCustomSeparator() throws Exception {
        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder().withPathSeparator('.').build();
    ...
    public void isMatchWithIgnoreCase() throws Exception {
        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder().withIgnoreCase().build();
    ...
    public void isMatchWithIgnoreCaseWithCustomPathSeparator() throws Exception {
        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder()
                .withIgnoreCase()
    ...
    public void isMatchWithMatchStart() {
        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder().withMatchStart().build();
    ...
    public void isMatchWithTrimTokens() {
        final AntPathMatcherArrays pathMatcher = new AntPathMatcherArrays.Builder().withTrimTokens().build();
    ...
    public void isMatchWithIgnoreCaseWithCustomPathSeparatorWithTrimTokens() throws Exception {
        ...
        assertTrue(pathMatcher.isMatch(".?", ".       A"));
        assertTrue(pathMatcher.isMatch(".?.a", ".a.A"));
        assertTrue(pathMatcher.isMatch(".a.??", ".       a      .     B       b"));
        assertTrue(pathMatcher.isMatch(".?", ".a"));
        assertTrue(pathMatcher.isMatch(".**", ".testing       .   teSting"));
        assertTrue(pathMatcher.isMatch(".*.**", ".testing.testing"));
        assertTrue(pathMatcher.isMatch(".**.*", "    .         tEsting .    testinG"));
        assertTrue(pathMatcher.isMatch("http:..example.org", " H t T p : . . exAmple . org"));
        assertTrue(pathMatcher.isMatch("HTTP:..EXAMPLE.ORG", "HtTp:..exAmple.org"));
    }
}
